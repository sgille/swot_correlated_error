...
#noise = ['altimeter', 'baseline_dilation', 'karin', 'orbital', 'roll_phase', 'timing', 'wet_troposphere']
noise = ['altimeter', 'baseline_dilation', 'karin', 'orbital', 'roll_phase', 'timing']
...
# directory
working_directory = '/home/sgille/swot_simulator'
